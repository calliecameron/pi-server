...
from conftest import CronRunner, Lines, ShadowDir, ShadowFile
...
class Host:
    ...
    def run_crons(self, time: str = '', cmd_to_watch: str = '',
                  disable_sources_list: bool = True, date: str = '') -> CronRunner: ...

    def client_ip(self) -> str: ...
    def disable_login_emails(self) -> ContextManager[None]: ...
    def make_bigfile(self, path: str, mount_point: str) -> None: ...
    def mount_backup_dir(self) -> ContextManager[None]: ...
    def exists(self, command: str) -> bool: ...
    def journal(self, service: str) -> Lines: ...
    process: Process
